...
<link crossorigin="anonymous" media="all" rel="stylesheet" href="https://github.githubassets.com/assets/notifications-subscriptions-menu.d40f461d8433baaa.module.css" />
  ...
  <title>2-SAT-Solver-using-Strongly-Connected-Components-SCC-/two-sat-solver/src/main.cpp at main · Yuvraj1633/2-SAT-Solver-using-Strongly-Connected-Components-SCC- · GitHub</title>
  ...
  <meta name="fetch-nonce" content="v2:b9214815-1856-ed08-7ea5-6a6f20021e6d">

    
  <meta name="current-catalog-service-hash" content="f3abb0cc802f3d7b95fc8762b94bdcb13bf39634c40c357301c4aa1d67a256fb">


  <meta name="request-id" content="FA40:276ACC:19DB8B0:1CD40CB:6A67592E" data-pjax-transient="true"/><meta name="html-safe-nonce" content="7050de99a8a1da132236c45a43d4223b685f7804fe8f89441df230d88cc44483" data-pjax-transient="true"/><meta name="visitor-payload" content="eyJyZWZlcnJlciI6IiIsInJlcXVlc3RfaWQiOiJGQTQwOjI3NkFDQzoxOURCOEIwOjFDRDQwQ0I6NkE2NzU5MkUiLCJ2aXNpdG9yX2lkIjoiODAwNTc2NzIzNTYzMzYzMzU4MiIsInJlZ2lvbl9lZGdlIjoiY2VudHJhbGluZGlhIiwicmVnaW9uX3JlbmRlciI6ImNlbnRyYWxpbmRpYSJ9" data-pjax-transient="true"/><meta name="visitor-hmac" content="5ea62e63f23ac9c3a3e5c655a1c4369cdea5076595ba52af08ccb48d2bdf3e84" data-pjax-transient="true"/>
...
<meta name="octolytics-url" content="https://collector.github.com/github/collect" />
  ...
  <meta name="analytics-location" content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-turbo-transient="true" />
    ...
    <meta name="viewport" content="width=device-width">
      ...
      <meta name="description" content="Implemented an efficient 2-SAT solver using Strongly Connected Components (Kosaraju&#39;s algorithm) on implication graphs. Demonstrated graph-based reasoning and algorithmic problem solving. - 2-SAT-Solver-using-Strongly-Connected-Components-SCC-/two-sat-solver/src/main.cpp at main · Yuvraj1633/2-SAT-Solver-using-Strongly-Connected-Components-SCC-">

      <link rel="search" type="application/opensearchdescription+xml" href="/opensearch.xml" title="GitHub">

    <link rel="fluid-icon" href="https://github.com/fluidicon.png" title="GitHub">
    <meta property="fb:app_id" content="1401488693436528">
    <meta name="apple-itunes-app" content="app-id=1477376905, app-argument=https://github.com/Yuvraj1633/2-SAT-Solver-using-Strongly-Connected-Components-SCC-/blob/main/two-sat-solver/src/main.cpp" />
  ...
  <div class="d-flex flex-column flex-lg-row flex-items-center tmp-px-3 tmp-px-md-4 tmp-px-lg-5 height-full position-relative z-1">
    ...
    <path d="M10.226 17.284c-2.965-.36-5.054-2.493-5.054-5.256 0-1.123.404-2.336 1.078-3.144-.292-.741-.247-2.314.09-2.965.898-.112 2.111.36 2.83 1.01.853-.269 1.752-.404 2.853-.404 1.1 0 1.999.135 2.807.382.696-.629 1.932-1.1 2.83-.988.315.606.36 2.179.067 2.942.72.854 1.101 2 1.101 3.167 0 2.763-2.089 4.852-5.098 5.234.763.494 1.28 1.572 1.28 2.807v2.336c0 .674.561 1.056 1.235.786 4.066-1.55 7.255-5.615 7.255-10.646C23.5 6.188 18.334 1 11.978 1 5.62 1 .5 6.188.5 12.545c0 4.986 3.167 9.12 7.435 10.669.606.225 1.19-.18 1.19-.786V20.63a2.9 2.9 0 0 1-1.078.224c-1.483 0-2.359-.808-2.987-2.313-.247-.607-.517-.966-1.034-1.033-.27-.023-.359-.135-.359-.27 0-.27.45-.471.898-.471.652 0 1.213.404 1.797 1.235.45.651.921.943 1.483.943.561 0 .92-.202 1.437-.719.382-.381.674-.718.944-.943"></path>
      ...
      <div class="d-flex flex-1 flex-order-2 text-right d-lg-none gap-2 flex-justify-end">
          <a
            href="/login?return_to=https%3A%2F%2Fgithub.com%2FYuvraj1633%2F2-SAT-Solver-using-Strongly-Connected-Components-SCC-%2Fblob%2Fmain%2Ftwo-sat-solver%2Fsrc%2Fmain.cpp"
            class="HeaderMenu-link HeaderMenu-button d-inline-flex f5 no-underline border color-border-default rounded-2 px-2 py-1 color-fg-inherit js-prevent-focus-on-mobile-nav"
            data-hydro-click="{&quot;event_type&quot;:&quot;authentication.click&quot;,&quot;payload&quot;:{&quot;location_in_page&quot;:&quot;site header menu&quot;,&quot;repository_id&quot;:null,&quot;auth_type&quot;:&quot;SIGN_UP&quot;,&quot;originating_url&quot;:&quot;https://github.com/Yuvraj1633/2-SAT-Solver-using-Strongly-Connected-Components-SCC-/blob/main/two-sat-solver/src/main.cpp&quot;,&quot;user_id&quot;:null}}" data-hydro-click-hmac="d54121da2e594cf18ce3ae5826d0d142191c1bb68e47a118b8418b49923ae837"
            data-analytics-event="{&quot;category&quot;:&quot;Marketing nav&quot;,&quot;action&quot;:&quot;click to Sign in&quot;,&quot;label&quot;:&quot;ref_page:Marketing;ref_cta:Sign in;ref_loc:Header&quot;}"
          >
            Sign in
          </a>
              <div class="AppHeader-appearanceSettings">
    <react-partial-anchor>        <button data-target="react-partial-anchor.anchor" id="icon-button-cd4aba87-b496-45cb-910b-96c432276ea4" aria-labelledby="tooltip-64801851-43ad-445e-9f2f-d6dc53bcb1cc" type="button" disabled="disabled" data-view-component="true" class="Button Button--iconOnly Button--invisible Button--medium AppHeader-button HeaderMenu-link border cursor-wait">  <svg aria-hidden="true" data-component="Octicon" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-sliders Button-visual">
    <path d="M15 2.75a.75.75 0 0 1-.75.75h-4a.75.75 0 0 1 0-1.5h4a.75.75 0 0 1 .75.75Zm-8.5.75v1.25a.75.75 0 0 0 1.5 0v-4a.75.75 0 0 0-1.5 0V2H1.75a.75.75 0 0 0 0 1.5H6.5Zm1.25 5.25a.75.75 0 0 0 0-1.5h-6a.75.75 0 0 0 0 1.5h6ZM15 8a.75.75 0 0 1-.75.75H11.5V10a.75.75 0 1 1-1.5 0V6a.75.75 0 0 1 1.5 0v1.25h2.75A.75.75 0 0 1 15 8Zm-9 5.25v-2a.75.75 0 0 0-1.5 0v1.25H1.75a.75.75 0 0 0 0 1.5H4.5v1.25a.75.75 0 0 0 1.5 0v-2Zm9 0a.75.75 0 0 1-.75.75h-6a.75.75 0 0 1 0-1.5h6a.75.75 0 0 1 .75.75Z"></path>
</svg>
</button><tool-tip id="tooltip-64801851-43ad-445e-9f2f-d6dc53bcb1cc" for="icon-button-cd4aba87-b496-45cb-910b-96c432276ea4" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Appearance settings</tool-tip>
...
<qbsearch-input class="search-input" data-scope="repo:Yuvraj1633/2-SAT-Solver-using-Strongly-Connected-Components-SCC-" data-custom-scopes-path="/search/custom_scopes" data-delete-custom-scopes-csrf="S_LAqLmoTQ3QLGkqG_5eWFs-XKy-SQ1Cb2HKRzv0Pzcy7pBio_oRzKPZyP9a7r3wH5RGa-22WlPeh3PA3xw33w" data-max-custom-scopes="10" data-header-redesign-enabled="false" data-initial-value="" data-blackbird-suggestions-path="/search/suggestions" data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations" data-current-repository="Yuvraj1633/2-SAT-Solver-using-Strongly-Connected-Components-SCC-" data-current-org="" data-current-owner="Yuvraj1633" data-logged-in="false" data-copilot-chat-enabled="false" data-nl-search-enabled="false" data-retain-scroll-position="true">
  <div
    ...
    <path d="M10.68 11.74a6 6 0 0 1-7.922-8.982 6 6 0 0 1 8.982 7.922l3.04 3.04a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215ZM11.5 7a4.499 4.499 0 1 0-8.997 0A4.499 4.499 0 0 0 11.5 7Z"></path>
        ...
        <div data-target="query-builder.styledInputContainer" class="QueryBuilder-StyledInputContainer">
          ...
          <div class="QueryBuilder-InputWrapper">
            ...
            <input id="query-builder-test" name="query-builder-test" value="" autocomplete="off" type="text" role="combobox" spellcheck="false" aria-expanded="false" aria-describedby="validation-22ea260d-cad9-4f4b-a432-33e95e8f0c8f" data-target="query-builder.input" data-action="
...
<template id="device-desktop-icon">
  <svg aria-hidden="true" data-component="Octicon" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-device-desktop">
    <path d="M14.25 1c.966 0 1.75.784 1.75 1.75v7.5A1.75 1.75 0 0 1 14.25 12h-3.727c.099 1.041.52 1.872 1.292 2.757A.752.752 0 0 1 11.25 16h-6.5a.75.75 0 0 1-.565-1.243c.772-.885 1.192-1.716 1.292-2.757H1.75A1.75 1.75 0 0 1 0 10.25v-7.5C0 1.784.784 1 1.75 1ZM1.75 2.5a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h12.5a.25.25 0 0 0 .25-.25v-7.5a.25.25 0 0 0-.25-.25ZM9.018 12H6.982a5.72 5.72 0 0 1-.765 2.5h3.566a5.72 5.72 0 0 1-.765-2.5Z"></path>
      ...
      <div class="FormControl-inlineValidation" id="validation-22ea260d-cad9-4f4b-a432-33e95e8f0c8f" hidden="hidden">
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <scrollable-region data-labelled-by="feedback-dialog-title">
        <div data-view-component="true" class="Overlay-body">        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="code-search-feedback-form" data-turbo="false" action="/search/feedback" accept-charset="UTF-8" method="post"><input type="hidden" data-csrf="true" name="authenticity_token" value="CJ9X3WX+L+t/3v2P7Re1E1iKZTLxsSq3caCEWmI2fF25uUPGX7mRj0MMuJJvG5PLA8bupWvlUTo3VWvT7RTbzg==" />
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <scrollable-region data-labelled-by="custom-scopes-dialog-title">
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="custom-scopes-dialog-form" data-turbo="false" action="/search/custom_scopes" accept-charset="UTF-8" method="post"><input type="hidden" data-csrf="true" name="authenticity_token" value="YHWvcqRi6sK5hY0eV0iKIXpw76JqzIvtMRh9k9CAF5k3UDuucFDcXnetqfdRDe+wpsk+ACMhAvmCsUL2UJaPSg==" />
          ...
          <div class="form-group">
            ...
            <auto-check src="/search/custom_scopes/check_name" required>
              <input
                ...
                required
                maxlength="50">
              <input type="hidden" data-csrf="true" value="aGU34MNa5CBI9Duierz4oSfNYO2qVtL4QMWYGoPv6PTw5Ef0Zv1Z3IVht8w6NciMVY5QqqUapHKv75NKTQhO2Q==" />
            </auto-check>
          </div>
          ...
          <button form="custom-scopes-dialog-form" data-action="click:custom-scopes#customScopesSubmit" data-target="custom-scopes.customScopesSubmitButton" type="submit" data-view-component="true" class="btn-primary btn">    Create saved search
            ...
            <div class="position-relative HeaderMenu-link-wrap d-lg-inline-block">
              ...
              >
                ...
                <div class="AppHeader-appearanceSettings">
    <react-partial-anchor>        <button data-target="react-partial-anchor.anchor" id="icon-button-05ee0631-e88a-4129-a369-8f91dd49d034" aria-labelledby="tooltip-c05c94d8-2947-4ca3-8298-e3ad6b9fd63a" type="button" disabled="disabled" data-view-component="true" class="Button Button--iconOnly Button--invisible Button--medium AppHeader-button HeaderMenu-link border cursor-wait">  <svg aria-hidden="true" data-component="Octicon" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-sliders Button-visual">
    <path d="M15 2.75a.75.75 0 0 1-.75.75h-4a.75.75 0 0 1 0-1.5h4a.75.75 0 0 1 .75.75Zm-8.5.75v1.25a.75.75 0 0 0 1.5 0v-4a.75.75 0 0 0-1.5 0V2H1.75a.75.75 0 0 0 0 1.5H6.5Zm1.25 5.25a.75.75 0 0 0 0-1.5h-6a.75.75 0 0 0 0 1.5h6ZM15 8a.75.75 0 0 1-.75.75H11.5V10a.75.75 0 1 1-1.5 0V6a.75.75 0 0 1 1.5 0v1.25h2.75A.75.75 0 0 1 15 8Zm-9 5.25v-2a.75.75 0 0 0-1.5 0v1.25H1.75a.75.75 0 0 0 0 1.5H4.5v1.25a.75.75 0 0 0 1.5 0v-2Zm9 0a.75.75 0 0 1-.75.75h-6a.75.75 0 0 1 0-1.5h6a.75.75 0 0 1 .75.75Z"></path>
</svg>
</button><tool-tip id="tooltip-c05c94d8-2947-4ca3-8298-e3ad6b9fd63a" for="icon-button-05ee0631-e88a-4129-a369-8f91dd49d034" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Appearance settings</tool-tip>
...
>
  ...
  <div data-target="react-partial.reactRoot"></div>
    ...
    <button id="icon-button-240c3d63-4d0b-400f-b87a-5ed2c95a3ec0" aria-labelledby="tooltip-43673028-a191-480e-8da4-b82058a2a2d2" type="button" data-view-component="true" class="Button Button--iconOnly Button--invisible Button--medium flash-close js-flash-close">  <svg aria-hidden="true" data-component="Octicon" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-x Button-visual">
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
</svg>
</button><tool-tip id="tooltip-43673028-a191-480e-8da4-b82058a2a2d2" for="icon-button-240c3d63-4d0b-400f-b87a-5ed2c95a3ec0" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Dismiss alert</tool-tip>
...
<div class="flash flash-full   {{ className }}">
  ...
  <li>
        ...
        <a href="/login?return_to=%2FYuvraj1633%2F2-SAT-Solver-using-Strongly-Connected-Components-SCC-" rel="nofollow" data-hydro-click="{&quot;event_type&quot;:&quot;authentication.click&quot;,&quot;payload&quot;:{&quot;location_in_page&quot;:&quot;star button&quot;,&quot;repository_id&quot;:1030340071,&quot;auth_type&quot;:&quot;LOG_IN&quot;,&quot;originating_url&quot;:&quot;https://github.com/Yuvraj1633/2-SAT-Solver-using-Strongly-Connected-Components-SCC-/blob/main/two-sat-solver/src/main.cpp&quot;,&quot;user_id&quot;:null}}" data-hydro-click-hmac="173be366c2dea41ca1e3089d1d0e38cd37d6981b31f84cabef66b5e2b1af3fda" aria-label="You must be signed in to star a repository" data-view-component="true" class="tooltipped tooltipped-sw btn-sm btn">    <svg aria-hidden="true" data-component="Octicon" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-star v-align-text-bottom d-inline-block mr-2 tmp-mr-2">
  ...
  <focus-group direction="vertical" mnemonics retain>
    <button id="action-menu-9c6610ec-671a-4af5-8fd5-f246c53fc120-button" popovertarget="action-menu-9c6610ec-671a-4af5-8fd5-f246c53fc120-overlay" aria-controls="action-menu-9c6610ec-671a-4af5-8fd5-f246c53fc120-list" aria-haspopup="true" aria-labelledby="tooltip-9eddfdaf-98c2-416e-8ff9-baa7d0279eb7" type="button" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium UnderlineNav-item">  <svg aria-hidden="true" data-component="Octicon" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-kebab-horizontal Button-visual">
    <path d="M8 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3ZM1.5 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Zm13 0a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path>
</svg>
</button><tool-tip id="tooltip-9eddfdaf-98c2-416e-8ff9-baa7d0279eb7" for="action-menu-9c6610ec-671a-4af5-8fd5-f246c53fc120-button" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Additional navigation options</tool-tip>


<anchored-position data-target="action-menu.overlay" id="action-menu-9c6610ec-671a-4af5-8fd5-f246c53fc120-overlay" anchor="action-menu-9c6610ec-671a-4af5-8fd5-f246c53fc120-button" align="start" side="outside-bottom" anchor-offset="normal" popover="auto" data-view-component="true">
  <div data-view-component="true" class="Overlay Overlay--size-auto">
    
      <div data-view-component="true" class="Overlay-body Overlay-body--paddingNone">          <action-list>
  <div data-view-component="true">
    <ul aria-labelledby="action-menu-9c6610ec-671a-4af5-8fd5-f246c53fc120-button" id="action-menu-9c6610ec-671a-4af5-8fd5-f246c53fc120-list" role="menu" data-view-component="true" class="ActionListWrap--inset ActionListWrap">
        <li hidden="hidden" data-menu-item="i0code-tab" data-targets="action-list.items" role="none" data-view-component="true" class="ActionListItem">
    
    
    <a tabindex="-1" id="item-d3e16fbe-b810-451a-9110-7db2a3dd676d" href="/Yuvraj1633/2-SAT-Solver-using-Strongly-Connected-Components-SCC-" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
    ...
    <a tabindex="-1" id="item-a1497729-f6ef-49e6-b94b-c4ddb5bc2eff" href="/Yuvraj1633/2-SAT-Solver-using-Strongly-Connected-Components-SCC-/issues" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" data-component="Octicon" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-issue-opened">
    <path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path><path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-efd776da-8d58-472a-8d17-73c2249e0f5e" href="/Yuvraj1633/2-SAT-Solver-using-Strongly-Connected-Components-SCC-/pulls" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <a tabindex="-1" id="item-36ca09b8-22dc-4bf6-b986-3c0fff84a7d2" href="/Yuvraj1633/2-SAT-Solver-using-Strongly-Connected-Components-SCC-/actions" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" data-component="Octicon" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-play">
    <path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Zm4.879-2.773 4.264 2.559a.25.25 0 0 1 0 .428l-4.264 2.559A.25.25 0 0 1 6 10.559V5.442a.25.25 0 0 1 .379-.215Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-59ddcd78-aa6e-4347-b97b-e8fa2e3f312d" href="/Yuvraj1633/2-SAT-Solver-using-Strongly-Connected-Components-SCC-/projects" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <a tabindex="-1" id="item-8da9d043-3846-48ca-b775-586b097f38a6" href="/Yuvraj1633/2-SAT-Solver-using-Strongly-Connected-Components-SCC-/security" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <a tabindex="-1" id="item-154b97db-7e5d-4e4d-85f3-196815816846" href="/Yuvraj1633/2-SAT-Solver-using-Strongly-Connected-Components-SCC-/pulse" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<react-app
  app-name="code-view"
  initial-path="/Yuvraj1633/2-SAT-Solver-using-Strongly-Connected-Components-SCC-/blob/main/two-sat-solver/src/main.cpp"
